            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
                ...
                <div>
                    ...
                    <div class="flex space-x-4 mt-8">
                        <a href="https://facebook.com/tappayz/"
                        ...
                        <a href="https://www.youtube.com/@tappayzlimited"
                            class="w-10 h-10 bg-white bg-opacity-20 rounded-full flex items-center justify-center hover:bg-opacity-30 transition-all">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                        ...
                        <a href="https://www.trustpilot.com/review/tappayz.com" class="max-w-[100px] border rounded-md">
                ...
                <div>
                    ...
                    <div class="space-y-4 text-gray-300">
                        ...
                        <div>
                            ...
                            <p>1 Sunnydene Rd, Purley CR8 2DJ, United Kingdom</p>
                        </div>
                    </div>
                </div>
            </div>
