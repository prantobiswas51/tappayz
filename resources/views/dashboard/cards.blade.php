        ...
        <div class="bg-white rounded-2xl  border-gray-200 shadow-sm">
            ...
            <div class="flex items-center space-x-6 border my-2 rounded-md p-4 shadow-sm">
                ...
                <div class="flex items-center space-x-4">
                    @if($card->state == 4)
                    <div
                        class="bg-yellow-600 text-white hover:cursor-not-allowed text-sm font-medium transition-colors border border-yellow-600 px-3 py-1 rounded-lg flex items-center space-x-2">
